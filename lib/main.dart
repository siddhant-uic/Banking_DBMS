...
import 'package:banking_app/services/db.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  final Future<Database> _initDb = initDB();
...
''');
                        ...
                        List<Map<String, Object?>>? list2 =
                            await snapshot.data?.rawQuery("SELECT * FROM citizen;");
                        print(list2);
                        
                      },
                      child: const Text("print tables"),
                    ),
                    const Text(
